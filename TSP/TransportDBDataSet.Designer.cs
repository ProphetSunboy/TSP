    ...
    public partial class TransportDBDataSet : global::System.Data.DataSet {
        ...
        public partial class TransportDataTable : global::System.Data.TypedTableBase<TransportRow> {
            ...
            private void InitClass() {
                ...
                this.columnРасход_топлива = new global::System.Data.DataColumn("Расход топлива", typeof(float), null, global::System.Data.MappingType.Element);
...
namespace TSP.TransportDBDataSetTableAdapters {
    ...
    public partial class TransportTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Transport] WHERE (([Id] = @Original_Id) AND ([Название] = @Ori" +
                "ginal_Название) AND ([Скорость] = @Original_Скорость) AND ([Расход топлива] = @O" +
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Расход_топлива", global::System.Data.SqlDbType.Real, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Расход топлива", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Transport] ([Название], [Скорость], [Расход топлива]) VALUES (" +
                "@Название, @Скорость, @Расход_топлива);\r\nSELECT Id, Название, Скорость, [Расход " +
                "топлива] FROM Transport WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Расход_топлива", global::System.Data.SqlDbType.Real, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Расход топлива", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Transport] SET [Название] = @Название, [Скорость] = @Скорость, [Расход топлива] = @Расход_топлива WHERE (([Id] = @Original_Id) AND ([Название] = @Original_Название) AND ([Скорость] = @Original_Скорость) AND ([Расход топлива] = @Original_Расход_топлива));
SELECT Id, Название, Скорость, [Расход топлива] FROM Transport WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Расход_топлива", global::System.Data.SqlDbType.Real, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Расход топлива", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Расход_топлива", global::System.Data.SqlDbType.Real, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Расход топлива", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Название, Скорость, [Расход топлива] FROM dbo.Transport";
